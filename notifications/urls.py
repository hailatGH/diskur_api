...
urlpatterns = [
    ...
    pattern(r'^api/unread_count/$', views.live_unread_notification_count,
            name='live_unread_notification_count'),
    pattern(r'^api/all_count/$', views.live_all_notification_count,
            name='live_all_notification_count'),
    pattern(r'^api/unread_list/$', views.live_unread_notification_list,
            name='live_unread_notification_list'),
    pattern(r'^api/all_list/', views.live_all_notification_list,
            name='live_all_notification_list'),
    pattern(r'^api/mark_all_as_read', views.live_mark_all_as_read,
            name='live_mark_all_as_read'),
    pattern(r'^api/mark_as_read/(?P<pk>\d+)/$', views.live_mark_as_read,
            name='live_mark_as_read'),
    pattern(r'^api/mark-messages-as-read/$',
            views.live_mark_messages_as_read, name='live_mark_messages_as_read'),
]
