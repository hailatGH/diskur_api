    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telegram_chat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='telegram_states', to='moogter_bot.telegramchat')),
                ('telegram_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='telegram_states', to='moogter_bot.telegramuser')),
            ],
            options={
